...
\begin{figure}[h]
	...
	{\label{lst:and_gate}
		\mylistingnumbernear{.28}{text}{code/qa_prolog/and.qmasm}
	}
	\quad
	\subfloat[\emph{not} gate]
	{\label{lst:not_gate}
		\mylistingnumbernear{.28}{text}{code/qa_prolog/not.qmasm}
	}
	\quad
	\subfloat[\emph{or} gate]
	{\label{lst:or_gate}
		\mylistingnumbernear{.28}{text}{code/qa_prolog/or.qmasm}
	}
